...
export function activate(context: vscode.ExtensionContext) {
    ...
    let switchToCopperDark = vscode.commands.registerCommand('multiBg.switchToCopperDark', () => {
        vscode.workspace.getConfiguration('workbench').update('colorTheme', 'Copper Dark', vscode.ConfigurationTarget.Global);
    });
    ...
    let switchToAkariDawn = vscode.commands.registerCommand('multiBg.switchToAkariDawn', () => {
        vscode.workspace.getConfiguration('workbench').update('colorTheme', 'Akari Dawn', vscode.ConfigurationTarget.Global);
        vscode.window.showInformationMessage('🌅 Switched to Akari Dawn Theme! Experience the serene light coding environment.');
    });

    let switchToAkariNight = vscode.commands.registerCommand('multiBg.switchToAkariNight', () => {
        vscode.workspace.getConfiguration('workbench').update('colorTheme', 'Akari Night', vscode.ConfigurationTarget.Global);
        vscode.window.showInformationMessage('🌙 Switched to Akari Night Theme! Experience the serene dark coding environment.');
    });
    ...
    let switchToNexusDark = vscode.commands.registerCommand('multiBg.switchToNexusDark', () => {
        vscode.workspace.getConfiguration('workbench').update('colorTheme', 'Nexus Dark', vscode.ConfigurationTarget.Global);
        vscode.window.showInformationMessage('🌌 Switched to Nexus Dark Theme! Experience the modern dark coding environment.');
    });

    let switchToEspressoDark = vscode.commands.registerCommand('multiBg.switchToEspressoDark', () => {
        vscode.workspace.getConfiguration('workbench').update('colorTheme', 'Espresso Dark', vscode.ConfigurationTarget.Global);
        vscode.window.showInformationMessage('☕ Switched to Espresso Dark Theme! Experience the rich coffee-inspired dark coding environment.');
    });
